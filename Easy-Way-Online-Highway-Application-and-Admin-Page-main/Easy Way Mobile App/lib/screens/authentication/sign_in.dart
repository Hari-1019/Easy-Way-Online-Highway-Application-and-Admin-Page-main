...
// Google Sign-In temporarily disabled to avoid API/compile mismatch during build
...
class _SignInState extends State<SignIn> {
  ...
  // GoogleSignIn instance removed while Google sign-in is disabled
  ...
  // Temporary stub for Google Sign-In (disabled for now to avoid package API mismatches)
  Future<void> _signInWithGoogle() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Google Sign-In is disabled in this build.')),
    );
  }
