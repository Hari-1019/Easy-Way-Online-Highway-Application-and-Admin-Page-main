...
class _HospitalMapPageState extends State<HospitalMapPage> {
  ...
  final List<LatLng> _hospitals = [
    ...
    const LatLng(6.9271, 79.8612), // Colombo National Hospital
    const LatLng(6.9776, 80.2311), // Kandy General Hospital
    const LatLng(7.2504, 80.6137), // Galle District General Hospital
    const LatLng(6.7340, 80.0361), // Anuradhapura Teaching Hospital
